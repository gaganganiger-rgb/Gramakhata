...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull CoordinatorLayout rootView,
      ...
      @NonNull RecyclerView rvCustomers, @NonNull TextView tvDebtorCount,
      @NonNull TextView tvEmptyState, @NonNull TextView tvTotalDue) {
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainBinding((CoordinatorLayout) rootView, appBarLayout, btnShareReport,
          etSearch, fabAddCustomer, rvCustomers, tvDebtorCount, tvEmptyState, tvTotalDue);
    }
