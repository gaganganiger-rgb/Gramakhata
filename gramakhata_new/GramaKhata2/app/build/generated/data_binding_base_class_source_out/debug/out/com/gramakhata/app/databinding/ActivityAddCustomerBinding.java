...
public final class ActivityAddCustomerBinding implements ViewBinding {
  ...
  private ActivityAddCustomerBinding(@NonNull LinearLayout rootView,
      ...
      @NonNull MaterialButton btnSave, @NonNull TextInputEditText etMobile,
      @NonNull TextInputEditText etName, @NonNull CircleImageView ivCustomerPhoto,
  ...
  public static ActivityAddCustomerBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityAddCustomerBinding((LinearLayout) rootView, btnCamera, btnGallery, btnSave,
          etMobile, etName, ivCustomerPhoto, toolbar);
    }
